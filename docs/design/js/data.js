...
window.BanheirosData = (function () {
  var takenUsernames = ["raul", "admin", "teste", "maria", "ana", "joao", "convidado_google"];
  ...
  return { CATEGORY_META: CATEGORY_META, bathrooms: bathrooms, avg: avg, takenUsernames: takenUsernames };
})();
