...
function BanheirosProfileScreen(props) {
  ...
  var _tfa = React.useState(false); var twoFa = _tfa[0], setTwoFa = _tfa[1];
  var user = props.user;
  ...
  return React.createElement("div", { className: "screen screen-pad", "data-screen-label": "Profile" },
    ...
    React.createElement("div", { className: "profile-header" },
      React.createElement("div", { className: "avatar" }, user.name.slice(0, 1).toUpperCase()),
      React.createElement("div", null,
        React.createElement("div", { style: { fontWeight: 700, fontFamily: "var(--font-heading)", fontSize: 17 } }, user.name),
